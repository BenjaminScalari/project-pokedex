  ...
  return (
    <div className="relative w-2/3 sm:w-1/2 xl:w-1/3">
      <input
        ...
        className="w-full py-2 pl-12 pr-16 border border-gray-300 rounded-full shadow-md focus:outline-none focus:ring-2 focus:ring-violet-500 text-black placeholder-gray-500"
      />
