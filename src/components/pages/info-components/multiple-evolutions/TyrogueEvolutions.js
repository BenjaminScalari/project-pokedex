...
// Definiamo le evoluzioni di Tyrogue con Hitmonlee, Hitmonchan e Hitmontop
const tyrogueEvolutions = [
  { name: "hitmonlee", id: 106 }, // ID di Hitmonlee
  { name: "hitmonchan", id: 107 }, // ID di Hitmonchan
  { name: "hitmontop", id: 237 }, // ID di Hitmontop
];
...
const TyrogueEvolutions = () => {
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      setCurrentEvolutionIndex(
        (prevIndex) => (prevIndex + 1) % tyrogueEvolutions.length
      );
  ...
  const currentEvolution = tyrogueEvolutions[currentEvolutionIndex];
...
export default TyrogueEvolutions;
